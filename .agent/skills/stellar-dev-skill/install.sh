...
# Stellar Dev Skill Installer for Claude Code
# Usage: ./install.sh [--project | --path <path>]

set -e

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
SKILL_NAME="stellar-dev"
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        --path)
            ...
            ;;
        -h|--help)
            echo "Stellar Dev Skill Installer"
            echo ""
...
# Copy skill files
echo "Installing Stellar Dev Skill..."
...
echo "Try asking about Stellar development to activate it!"
